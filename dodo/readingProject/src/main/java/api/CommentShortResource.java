 ...
 */
@RestController
@RequestMapping(value = "/comment/short_book_review")
public class CommentShortResource {
    private static final Logger logger = LogManager.getLogger();
    private static final CommentShortService commentService = SpringIocUtil.getBean("commentShortService", CommentShortService.class);
    ...
    public String create(@RequestBody String req) {
        ...
        CommentShort reqComment = JSON.parseObject(req, CommentShort.class);
        CommentShort comment = null;
        try {
    ...
    public String listByReviewId(@PathVariable Long review_id) {
        ...
        List<CommentShort> results = new ArrayList<CommentShort>();
