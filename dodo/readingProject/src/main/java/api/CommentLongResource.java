 ...
 */
@RestController
@RequestMapping(value = "/comment/long_book_review")
public class CommentLongResource {
    private static final Logger logger = LogManager.getLogger();
    private static final CommentLongService commentService = SpringIocUtil.getBean("commentLongService", CommentLongService.class);
    ...
    public String create(@RequestBody String req) {
        ...
        CommentLong reqComment = JSON.parseObject(req, CommentLong.class);
        CommentLong comment = null;
        try {
    ...
    public String listByReviewId(@PathVariable Long review_id) {
        ...
        List<CommentLong> results = new ArrayList<CommentLong>();
